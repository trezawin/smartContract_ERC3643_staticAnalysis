...
/// @notice Minimal token that ignores compliance.canTransfer but keeps identity binding for structure.
contract TokenNoCompliance {
    string public name;
    ...
    function _transfer(address from, address to, uint256 amount) internal {
        ...
        // Note: does NOT check compliance.canTransfer (mutant)
